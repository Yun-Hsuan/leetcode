...
\begin{figure}[t]
	...
	\label{fig4312}
\end{figure}
For instance, if the target is to decompose a rank-3 $(N=3)$ tensor $A$ from 3 $(n=3)$ different modes, as in Fig.~\ref{fig4312}(a), we can implement it by the following steps, 
\begin{enumerate}
