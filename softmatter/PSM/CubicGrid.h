...
class Cubic{
	...
	public:
		...
		double PSM_Energy(double epsilon);
		double PSM_EnergyChange(std::vector<double>& vecTrail, int idx, double epsilon);
		void MonteOptPSM(int N, double maxDir, int print, double epsilon);
